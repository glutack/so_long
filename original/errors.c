...
void	ft_img_error(t_program *mlx)
{
	if (!mlx->img.wall || !mlx->img.selene || !mlx->img.path
		...
		|| !mlx->img.selenel || !mlx->img.paulinol1 || !mlx->img.moves
		|| !mlx->img.paulinol2 || !mlx->img.paulinol3 || !mlx->img.exit0
		|| !mlx->img.paulinor1 || !mlx->img.paulinor2 || !mlx->img.exit40
		|| !mlx->img.paulinor3 || !mlx->img.exit70 || !mlx->img.object40
		|| !mlx->img.object0 || !mlx->img.object70)
	{
		ft_img_eraser(mlx);
